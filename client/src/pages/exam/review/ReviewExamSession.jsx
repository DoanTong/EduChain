...
//   useEffect(() => {
//     // Nếu không có state → fetch từ API
//     if (!state) {
//       fetchReview();
//     }
//   }, [state]);
...
//   const realParts = Object.entries(results).map(([examId, r], idx) => {
//     if (!r || !r.total) return { part: `Part ${idx + 1}`, score: 0 };

//     const score = Number(((r.correct / r.total) * 100).toFixed(1));
//     return { part: `Part ${idx + 1}`, score };
//   });

//   while (realParts.length < MAX_PARTS) {
//     realParts.push({
//       part: `Part ${realParts.length + 1}`,
//       score: 0
//     });
//   }
...
//             <div className="summary-item">
//               <span>Sai:</span>
//               <strong className="text-red">{totalQuestions - totalCorrect}</strong>
//             </div>
